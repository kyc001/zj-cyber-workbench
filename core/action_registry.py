...
DEFAULT_ACTION_REGISTRY = ActionRegistry((
    ...
    ActionSpec("network.port.quickcheck", ("windows", "linux"), RiskLevel.L1, ("web",), 60, 256_000, True),
    ActionSpec("network.dns.trace", ("windows", "linux"), RiskLevel.L1, ("web",), 30, 256_000, True),
    ActionSpec("web.port.probe", ("windows", "linux"), RiskLevel.L1, ("web",), 60, 256_000, True),
    ActionSpec("web.http.request", ("windows", "linux"), RiskLevel.L1, ("web",), 60, 512_000, True),
    ActionSpec("web.http.probe", ("windows", "linux"), RiskLevel.L1, ("web",), 120, 512_000, True),
    ActionSpec("ops.system.info", ("windows", "linux"), RiskLevel.L0, ("local", "ssh"), 30, 256_000, True),
    ActionSpec("ops.disk.usage", ("windows", "linux"), RiskLevel.L1, ("file",), 120, 512_000, True),
    ActionSpec("ops.process.list", ("windows", "linux"), RiskLevel.L0, ("local", "ssh"), 30, 512_000, True),
    ActionSpec("ops.net.connections", ("windows", "linux"), RiskLevel.L0, ("local", "ssh"), 30, 512_000, True),
    ActionSpec("ops.env.check", ("windows", "linux"), RiskLevel.L0, ("local", "ssh"), 30, 256_000, True),
    ActionSpec("file.log.tail", ("windows", "linux"), RiskLevel.L1, ("file",), 30, 512_000, True),
    ActionSpec("file.log.grep", ("windows", "linux"), RiskLevel.L1, ("file",), 60, 512_000, True),
    ActionSpec("file.hash", ("windows", "linux"), RiskLevel.L1, ("file",), 60, 256_000, True),
    ActionSpec("archive.inspect", ("windows", "linux"), RiskLevel.L1, ("file",), 60, 512_000, True),
